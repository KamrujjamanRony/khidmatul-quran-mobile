...
@Component({
  ...
  imports: [FormsModule, CommonModule, ConfirmModalComponent, BanglaPipe, NetStatusComponent, CustomButtonComponent, HeadingTextComponent, FooterComponent, LoaderComponent]
})
